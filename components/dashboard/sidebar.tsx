...
import { Crosshair, Gamepad2, Settings, Trophy } from "lucide-react";
...
const navigation = [
  ...
  { name: "Account & privacy", href: "/dashboard/account", icon: Settings },
];
...
export function Sidebar() {
  ...
  return (
    <div className="flex h-full w-full flex-col bg-sidebar px-4 py-6 md:w-64 md:border-r md:border-border">
